...
import com.kaltura.netkit.backend.phoenix.data.KalturaLoginResponse;
import com.kaltura.netkit.backend.phoenix.data.KalturaLoginSession;
import com.kaltura.netkit.backend.phoenix.data.KalturaSession;
...
import com.kaltura.netkit.backend.phoenix.services.PhoenixSessionService;
...
public class OttSessionProvider extends BaseSessionProvider {
    ...
    /**
     * Ends current active session. if it's a {@link com.kaltura.netkit.backend.session.BaseSessionProvider.UserSessionType#User} session
     * logout, if {@link com.kaltura.netkit.backend.session.BaseSessionProvider.UserSessionType#Anonymous} will return, since
