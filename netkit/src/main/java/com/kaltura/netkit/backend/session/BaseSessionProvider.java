...
import static com.kaltura.netkit.backend.session.BaseSessionProvider.UserSessionType.Anonymous;
import static com.kaltura.netkit.backend.session.BaseSessionProvider.UserSessionType.User;
